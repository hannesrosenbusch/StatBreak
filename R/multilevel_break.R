...
#
  ...
  x = statistic_computation(data[is.element(data[,grouping_var],-excluded_groups),])
  output = list("excluded groups" = excluded_groups, "number_exclusions"= nr_excluded_groups, "new_value" = x)
